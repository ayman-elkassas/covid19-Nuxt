<template>
  <div>
      <vs-navbar
        style="z-index: 9999;"
        padding-scroll square
        fixed shadow-scroll center-collapsed v-model="active"
      >
        <template #left>
        ...
        <template>
          <vs-navbar-item
            ...
            <vs-avatar v-if="$auth.user.avatar==''" badge badge-color="success" history primary>
