                ...
                <nav class="nk-navbar-menu" id="navbar-menu">
                  <ul class="nk-menu">
                    <li class="nk-menu-item">
                      <router-link
                        to="/home/timeline"
                        class="scrollto nav-link nk-menu-link"
                      >
                        <span>Home</span>
                      </router-link>
            ...
            <div class="row g-gs align-items-center justify-content-between">
              <div class="col-lg-5 order-lg-last">
                <div class="nk-banner-image">
                  <img
                    src="~/assets/LandingStyle/images/gfx/header-a.png"
                    alt=""
                  />
                </div>
              </div>
                      ...
                      <div class="row g-gs">
                        <div class="col-sm-4 col-6">
                          <div class="status-item">
                            ...
                            <div class="h3 count covid-stats-cases">
                              144,392,003
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-4 col-6">
                          <div class="status-item">
                            ...
                            <div class="h3 count covid-stats-death">
                              3,070,116
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-4 col-6">
                          <div class="status-item">
                            ...
                            <div class="h3 count covid-stats-recovered">
                              122,572,594
                            </div>
                          </div>
                        </div>
              ...
              <div class="row g-gs justify-content-center">
                <div class="col-sm-10 col-md-8 col-lg-4">
                  <div class="box">
                    <div class="box-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/spread-a.png"
                        alt=""
                      />
                    </div>
                ...
                <div class="col-sm-10 col-md-8 col-lg-4">
                  <div class="box">
                    <div class="box-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/spread-b.png"
                        alt=""
                      />
                    </div>
                    <div class="box-content">
                ...
                <div class="col-sm-10 col-md-8 col-lg-4">
                  <div class="box">
                    <div class="box-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/spread-c.png"
                        alt=""
                      />
                    </div>
                    <div class="box-content">
              ...
              <div class="row g-gs justify-content-center">
                <div class="col-sm-10 col-md-8 col-lg-4">
                  <div class="box2">
                    <div class="box2-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/symptom-a.png"
                        alt=""
                      />
                    </div>
                ...
                <div class="col-sm-10 col-md-8 col-lg-4">
                  <div class="box2">
                    <div class="box2-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/symptom-b.png"
                        alt=""
                      />
                    </div>
                    <div class="box2-content">
                ...
                <div class="col-sm-10 col-md-8 col-lg-4">
                  <div class="box2">
                    <div class="box2-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/symptom-c.png"
                        alt=""
                      />
                    </div>
                    <div class="box2-content">
              ...
              <div class="row g-gs gy-sm-m">
                <div class="col-lg-3 col-sm-6">
                  <div class="box3">
                    <div class="box3-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/advice-a.png"
                        alt=""
                      />
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                  <div class="box3">
                    <div class="box3-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/advice-b.png"
                        alt=""
                      />
                    </div>
                    <div class="box3-content">
                ...
                <div class="col-lg-3 col-sm-6">
                  <div class="box3">
                    <div class="box3-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/advice-c.png"
                        alt=""
                      />
                    </div>
                    <div class="box3-content">
                ...
                <div class="col-lg-3 col-sm-6">
                  <div class="box3">
                    <div class="box3-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/advice-d.png"
                        alt=""
                      />
                    </div>
                    <div class="box3-content">
          ...
          <div class="container">
            <div class="section-content section-content-boxed">
              <div class="row g-gs justify-content-center align-items-center">
                ...
                <div class=" col-sm-10 col-md-8 col-lg-4">
                  <img
                    src="~/assets/LandingStyle/images/gfx/steps.png"
                    class="mb-2 mb-sm-0"
                    alt=""
                  />
                </div>
              ...
              <div class="row g-gs justify-content-center">
                <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                  <div class="box4">
                    <div class="box4-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/hand-a.png"
                        alt=""
                      />
                    </div>
                ...
                <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                  <div class="box4">
                    <div class="box4-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/hand-b.png"
                        alt=""
                      />
                    </div>
                    <div class="box4-content">
                ...
                <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                  <div class="box4">
                    <div class="box4-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/hand-c.png"
                        alt=""
                      />
                    </div>
                    <div class="box4-content">
                ...
                <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                  <div class="box4">
                    <div class="box4-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/hand-d.png"
                        alt=""
                      />
                    </div>
                    <div class="box4-content">
                ...
                <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                  <div class="box4">
                    <div class="box4-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/hand-e.png"
                        alt=""
                      />
                    </div>
                    <div class="box4-content">
                ...
                <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                  <div class="box4">
                    <div class="box4-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/hand-f.png"
                        alt=""
                      />
                    </div>
                    <div class="box4-content">
              ...
              <div class="row g-gs justify-content-center flex-lg-nowrap">
                <div class="col-md-8 col-lg-5 col-xl-6 align-self-end">
                  <div class="protect-block-gfx">
                    <img
                      src="~/assets/LandingStyle/images/gfx/protect.png"
                      alt=""
                    />
                  </div>
                </div>
                ...
                >
                  <div class="protect-item negative">
                    <div class="protect-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/donts-a.png"
                        alt=""
                      />
                    </div>
                  ...
                  <div class="protect-item negative">
                    <div class="protect-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/donts-b.png"
                        alt=""
                      />
                    </div>
                    <div class="protect-text">
                  ...
                  <div class="protect-item negative">
                    <div class="protect-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/donts-c.png"
                        alt=""
                      />
                    </div>
                    <div class="protect-text">
                ...
                >
                  <div class="protect-item positive">
                    <div class="protect-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/dos-a.png"
                        alt=""
                      />
                    </div>
                    <div class="protect-text">
                  ...
                  <div class="protect-item positive">
                    <div class="protect-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/dos-b.png"
                        alt=""
                      />
                    </div>
                    <div class="protect-text">
                  ...
                  <div class="protect-item positive">
                    <div class="protect-gfx">
                      <img
                        src="~/assets/LandingStyle/images/gfx/dos-c.png"
                        alt=""
                      />
                    </div>
                    <div class="protect-text">
              ...
              <div class="row g-gs justify-content-center">
                <div class="col-md-9 col-lg-4">
                  <div class="blog-item">
                    <div class="blog-image">
                      <img
                        src="~/assets/LandingStyle/images/blog/blog-a.jpg"
                        alt=""
                      />
                    </div>
                    <div class="blog-text">
                ...
                <div class="col-md-9 col-lg-4">
                  <div class="blog-item">
                    <div class="blog-image">
                      <img
                        src="~/assets/LandingStyle/images/blog/blog-b.jpg"
                        alt=""
                      />
                    </div>
                    <div class="blog-text">
                ...
                <div class="col-md-9 col-lg-4">
                  <div class="blog-item">
                    <div class="blog-image">
                      <img
                        src="~/assets/LandingStyle/images/blog/blog-c.jpg"
                        alt=""
                      />
                    </div>
                    <div class="blog-text">
